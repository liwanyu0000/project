...
"}")
        ...
        self.putAwayButton.setMinimumSize(QtCore.QSize(0, 0))
        self.putAwayButton.setMaximumSize(QtCore.QSize(15, 16777215))
        ...
        self.expandButton.setMinimumSize(QtCore.QSize(0, 0))
        self.expandButton.setMaximumSize(QtCore.QSize(15, 16777215))
...
"}")
        ...
        self.nameLabel = QtWidgets.QLabel(self.home)
...
"}")
        ...
        self.previouImageButton = QtWidgets.QPushButton(self.home)
        self.previouImageButton.setMinimumSize(QtCore.QSize(50, 50))
        self.previouImageButton.setMaximumSize(QtCore.QSize(50, 50))
        self.previouImageButton.setText("")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("icon/reduce.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.previouImageButton.setIcon(icon6)
        self.previouImageButton.setIconSize(QtCore.QSize(40, 40))
        self.previouImageButton.setObjectName("previouImageButton")
        self.horizontalLayout.addWidget(self.previouImageButton)
        self.nextImageButton = QtWidgets.QPushButton(self.home)
        self.nextImageButton.setMinimumSize(QtCore.QSize(50, 50))
        self.nextImageButton.setMaximumSize(QtCore.QSize(50, 50))
        self.nextImageButton.setText("")
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("icon/amplify.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.nextImageButton.setIcon(icon7)
        self.nextImageButton.setIconSize(QtCore.QSize(40, 40))
        ...
        self.homeLeftVerticalLayout.addLayout(self.horizontalLayout)
        ...
        self.putAwayFileListButton = QtWidgets.QPushButton(self.home)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.putAwayFileListButton.sizePolicy().hasHeightForWidth())
        self.putAwayFileListButton.setSizePolicy(sizePolicy)
        self.putAwayFileListButton.setMinimumSize(QtCore.QSize(0, 0))
        self.putAwayFileListButton.setMaximumSize(QtCore.QSize(10, 16777215))
        self.putAwayFileListButton.setStyleSheet("")
        self.putAwayFileListButton.setText("")
        self.putAwayFileListButton.setIcon(icon5)
        self.putAwayFileListButton.setAutoDefault(False)
        self.putAwayFileListButton.setDefault(False)
        self.putAwayFileListButton.setFlat(False)
        self.putAwayFileListButton.setObjectName("putAwayFileListButton")
        self.horizontalLayout_2.addWidget(self.putAwayFileListButton)
        self.expandFileListButton = QtWidgets.QPushButton(self.home)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.expandFileListButton.sizePolicy().hasHeightForWidth())
        self.expandFileListButton.setSizePolicy(sizePolicy)
        self.expandFileListButton.setMinimumSize(QtCore.QSize(0, 0))
        self.expandFileListButton.setMaximumSize(QtCore.QSize(10, 16777215))
        self.expandFileListButton.setStyleSheet("")
        self.expandFileListButton.setText("")
        self.expandFileListButton.setIcon(icon4)
        self.expandFileListButton.setAutoDefault(False)
        self.expandFileListButton.setDefault(False)
        self.expandFileListButton.setFlat(False)
        self.expandFileListButton.setObjectName("expandFileListButton")
        self.horizontalLayout_2.addWidget(self.expandFileListButton)
        self.tableWidget = QtWidgets.QTableWidget(self.home)
        ...
        self.queryHeadHorizontalLayout.addItem(spacerItem8)
        ...
        self.queryTableList.setColumnCount(10)
        ...
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.queryTableList.setHorizontalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.queryTableList.setHorizontalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.queryTableList.setHorizontalHeaderItem(5, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.queryTableList.setHorizontalHeaderItem(6, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.queryTableList.setHorizontalHeaderItem(7, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.queryTableList.setHorizontalHeaderItem(8, item)
        item = QtWidgets.QTableWidgetItem()
        item.setTextAlignment(QtCore.Qt.AlignCenter)
        self.queryTableList.setHorizontalHeaderItem(9, item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.folderButton.setToolTip(_translate("MainWindow", "选择文件夹"))
        ...
        item.setText(_translate("MainWindow", "已检测文件"))
        ...
        item.setText(_translate("MainWindow", "边异常"))
        item = self.queryTableList.horizontalHeaderItem(3)
        item.setText(_translate("MainWindow", "角异常"))
        item = self.queryTableList.horizontalHeaderItem(4)
        item.setText(_translate("MainWindow", "白色点瑕疵"))
        item = self.queryTableList.horizontalHeaderItem(5)
        item.setText(_translate("MainWindow", "浅色点瑕疵"))
        item = self.queryTableList.horizontalHeaderItem(6)
        item.setText(_translate("MainWindow", "深色点块瑕疵"))
        item = self.queryTableList.horizontalHeaderItem(7)
        item.setText(_translate("MainWindow", "光圈瑕疵"))
        item = self.queryTableList.horizontalHeaderItem(8)
        item.setText(_translate("MainWindow", "日期"))
        item = self.queryTableList.horizontalHeaderItem(9)
