...
"}")
        ...
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.settingWidget)
        ...
        self.floderLabel.setAlignment(QtCore.Qt.AlignCenter)
...
"background-color: rgba(48,148,243,80);}")
        ...
        self.centerVerticalLayout.addItem(spacerItem2)
...
"")
        ...
        self.bottomCenterHorizontalLayout.addItem(spacerItem4)
        ...
        self.centerHorizontalLayout.addItem(spacerItem5)
        self.verticalLayout_2.addLayout(self.centerHorizontalLayout)
        ...
        self.BHorizontalLayout.setContentsMargins(-1, -1, 20, -1)
        self.BHorizontalLayout.setSpacing(50)
        ...
        self.verticalLayout_2.addLayout(self.BHorizontalLayout)
...
"}")
        ...
        self.previouImageButton = QtWidgets.QPushButton(self.cameraWidget)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icon/reduce.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.previouImageButton.setIcon(icon2)
        ...
        self.nextImageButton = QtWidgets.QPushButton(self.cameraWidget)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icon/amplify.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.nextImageButton.setIcon(icon3)
